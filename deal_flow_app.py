    ...
    if not company_name:
        ...
        try:
            ...
            if not url:
                ...
                status_text.text('🧠 Analyzing data and generating SWOT...')
                ...
                # Display the Summary at the top in a colored box (st.info)
                st.info(f"**📋 Summary:** {swot_data.get('summary', 'No summary available.')}")
